		...
		>
			...
			>
				...
				<div>
					...
					<p className='mt-[8px] font-nor,al sm:text-[18ppx] text-[12px] sm:leading-[22px] leading-[16px] text-white'>
						Founded | Metaversus
					</p>
				</div>
				<p className='mt-[14px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white'>
